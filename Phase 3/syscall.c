...
/////////////////////////////
int argptrint(int n, int **pp, int size)
{
  int i;
  struct proc *curproc = myproc();
...
extern int sys_get_queue(void);
extern int sys_set_process_MHRRN(void);
extern int sys_set_system_MHRRN(void);
...
[SYS_get_queue] sys_get_queue,
[SYS_set_process_MHRRN] sys_set_process_MHRRN,
[SYS_set_system_MHRRN] sys_set_system_MHRRN,
